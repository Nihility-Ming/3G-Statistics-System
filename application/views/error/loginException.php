...
<link href="<?=base_url("application/views/styles/err.css")?>" rel="stylesheet" type="text/css" />
...
<body>
	<div class="box">
    	<a href="<?=site_url()?>" title="立即返回"><img src="<?=base_url("application/views/images/err.png")?>" /></a>
    	<h3>操作提示：<?=$msg?></h3>
